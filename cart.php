...
<head>
    ...
    <title>Shopping Cart - Minimalin</title>
    <!-- Bootstrap CSS -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group" style="width: 120px;">
                                        <button class="btn btn-outline-secondary btn-sm quantity-btn" type="button" data-action="decrease" data-id="<?php echo $item['id']; ?>">-</button>
                                        <input type="number" class="form-control form-control-sm text-center quantity-input" value="<?php echo $item['quantity']; ?>" min="1" data-id="<?php echo $item['id']; ?>">
                                        <button class="btn btn-outline-secondary btn-sm quantity-btn" type="button" data-action="increase" data-id="<?php echo $item['id']; ?>">+</button>
                                    </div>
                                </td>
                                <td>$<?php echo number_format($itemTotal, 2); ?></td>
                                <td>
                                    <a href="cart.php?action=remove&id=<?php echo $item['id']; ?>" class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            quantityBtns.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    input.value = value;
                    window.location.href = `cart.php?action=update&id=${id}&quantity=${value}`;
                });
            });
